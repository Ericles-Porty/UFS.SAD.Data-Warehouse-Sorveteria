...
BEGIN
	...
	BEGIN
		...
		IF NOT EXISTS (SELECT COD FROM DIM_PRODUTO WHERE COD = @ID_PRODUTO)
		BEGIN
...
BEGIN
	...
	BEGIN
		...
		IF NOT EXISTS (SELECT COD FROM DIM_ADICIONAL WHERE COD = @ID_ADICIONAL)
		BEGIN
...
BEGIN
	...
	BEGIN
		...
		IF NOT EXISTS (SELECT S.COD FROM DIM_SABOR S WHERE S.COD = @ID_SABOR )
		BEGIN
...
BEGIN
	...
	BEGIN
		...
		IF NOT EXISTS (SELECT L.COD FROM DIM_LOCAL L WHERE L.COD = @ID_LOCAL)
		BEGIN
