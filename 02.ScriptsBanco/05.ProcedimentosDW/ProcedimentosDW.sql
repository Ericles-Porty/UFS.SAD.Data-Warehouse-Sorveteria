...
BEGIN
	SET NOCOUNT ON
	DECLARE @ID_GRUPO_ADICIONAL INT, @QTD_ADICIONAIS INT
	DECLARE @ID_ADICIONAL INT, @ID_ITEM INT
		...
		BEGIN
			...
			BEGIN
				...
				-- CURSOR DOS ADICIONAIS DO GRUPO DW 4
					...
					-- ATUALIZAR O FATO. VOLTE PRA CÁ QUANDO VC FAZER A CARGA DO FATO
					CLOSE C_GRUPO_ADICIONAL
					DEALLOCATE C_GRUPO_ADICIONAL
				END
				FETCH C_GRUPO INTO @ID_GRUPO
			END
			CLOSE C_GRUPO
			...
			FETCH C_ADICIONAL INTO @ID_ADICIONAL
		END
		CLOSE C_ADICIONAL
		DEALLOCATE C_ADICIONAL

		FETCH C_ITEM_ADICIONAL INTO @ID_ITEM
	END
