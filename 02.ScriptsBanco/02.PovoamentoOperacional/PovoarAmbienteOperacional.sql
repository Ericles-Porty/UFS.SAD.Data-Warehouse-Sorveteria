-- SEQUENCES TO GENERATE IDS FIR TABLE TB_ITEM AND TB_VENDA
...
BEGIN
	...
	BEGIN
		...
		ELSE
		BEGIN 
			SET @ID_ADICIONAL = NULL
		END

		-- GENERATING RANDOM VOLUME
		...
		SET @VALOR = @VOLUME * (SELECT P.VALOR FROM TB_PRODUTO P
