...
BEGIN
    ...
    DECLARE @ID_SABOR INT,
			...
			@ID_ITEM INT,
			@QUANTIDADE_ADICIONAIS_SUNDAE INT = 2,
	...
	INSERT INTO #TB_VOLUME_MAX values('PICOLÉ',2)
	INSERT INTO #TB_VOLUME_MAX values ('BOLA DE SORVETE', 4)
	INSERT INTO #TB_VOLUME_MAX values ('SUNDAE', 1)
	INSERT INTO #TB_VOLUME_MAX values ('AÇAÍ P', 3)
	INSERT INTO #TB_VOLUME_MAX values ('AÇAÍ M', 2)
	INSERT INTO #TB_VOLUME_MAX values ('AÇAÍ G', 1)
...
SELECT * FROM TB_ITEM
EXEC SP_POVOAR_VENDAS '2022-01-01', '2024-01-02'

TRUNCATE TABLE TB_ITEM_ADICIONAL
