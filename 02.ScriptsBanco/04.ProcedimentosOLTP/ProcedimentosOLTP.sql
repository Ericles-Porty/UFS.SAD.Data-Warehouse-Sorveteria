...
-- FATO VENDA
GO
CREATE OR ALTER PROCEDURE SP_ETL_OLTP_TO_STAGING_FATO_VENDA(@DATA_CARGA DATETIME)
AS
BEGIN
...
-- BRIDGE ADICIONAL
GO
CREATE OR ALTER PROCEDURE SP_ETL_OLTP_TO_STAGING_BRIDGE_ADICIONAL(@DATA_CARGA DATETIME)
AS
BEGIN
